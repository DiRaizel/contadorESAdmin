...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 26-06-2020 a las 18:25:58
...
CREATE TABLE `ciudad` (
  `ciu_id` int(6) UNSIGNED NOT NULL,
  `ciu_nombre` varchar(255) NOT NULL DEFAULT '',
  `ciu_estado` int(1) UNSIGNED NOT NULL,
...
CREATE TABLE `configuracion` (
  ...
  `con_max` bigint(20) NOT NULL,
  `emp_id` bigint(20) NOT NULL,
  `sed_id` bigint(20) NOT NULL
...
INSERT INTO `configuracion` (`con_id`, `con_max`, `emp_id`, `sed_id`) VALUES
(1, 101, 1, 0);
...
INSERT INTO `empresa` (`emp_id`, `emp_nombre`, `emp_nit`, `emp_estado`, `ciu_id`) VALUES
(1, 'inget', '1', 'Inactiva', 173),
(2, 'claro', '2', 'Activa', 5),
(3, 'tigo', '3', 'Activa', 170),
(4, 'bancolombia', '4', 'Activa', 150),
(10, 'suzuki', '123', 'Activa', 173);
...
CREATE TABLE `entrada_salida` (
  `ensa_id` bigint(20) NOT NULL,
  `ensa_poblacion` bigint(11) NOT NULL,
  `emp_id` bigint(20) NOT NULL,
  `sed_id` bigint(20) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `entrada_salida` (`ensa_id`, `ensa_poblacion`, `emp_id`, `sed_id`) VALUES
(2, 0, 1, 0);
...
INSERT INTO `sede` (`sed_id`, `sed_nombre`, `sed_estado`, `ciu_id`, `emp_id`) VALUES
(0, 'Principal', 'Activa', 0, 0),
(1, 'bancolombia 0', 'Activa', 77, 4);
...
CREATE TABLE `usuario` (
  ...
  `usu_nombres` text NOT NULL,
  `usu_apellidos` text NOT NULL,
  `usu_documento` text NOT NULL,
  ...
  `usu_estado_password` text NOT NULL,
  `emp_id` bigint(20) NOT NULL,
  `sed_id` bigint(20) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `usuario` (`usu_id`, `usu_nombres`, `usu_apellidos`, `usu_documento`, `usu_correo`, `usu_rol`, `usu_password`, `usu_fecha`, `usu_estado`, `usu_estado_password`, `emp_id`, `sed_id`) VALUES
(1, 'admin', '', '0', 'admin@admin', 'Admin', 'MQ==', '2020-06-24', 'Activo', 'Normal', 0, 0),
(2, 'q', 'w', '1', 'q@q', 'Administrador', 'MQ==', '2020-06-26', 'Activo', 'Normal', 1, 0);
...
--
ALTER TABLE `ciudad`
  MODIFY `ciu_id` int(6) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1101;
...
--
ALTER TABLE `entrada_salida`
  MODIFY `ensa_id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT de la tabla `registro_entrada_salida`
--
ALTER TABLE `registro_entrada_salida`
...
--
ALTER TABLE `sede`
  MODIFY `sed_id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
